            ...
            <div>
                <div className="pb-4 2xl:flex w-11/12 mx-auto 2xl:justify-between">
                    ...
                    <div className="flex flex-col md:flex-row 2xl:flex-col 2xl:w-1/4 gap-2 pb-4">
                        <Link href={`${pathname}/?players=true`} className="text-center py-4  bg-zinc-400 font-bold uppercase rounded-lg">
                            {/* <FontAwesomeIcon icon={faUser} className="text-2xl pr-2" /> */}
                            Add Players
                        </Link>
                        <Link href={`${pathname}/?matches=true`} className="min-w-fit py-4 bg-zinc-400 text-center font-bold uppercase rounded-lg ">Create Match</Link>
                    </div>

                </div>

                <ol className="flex flex-col bg-23 w-full py-8 gap-2  lg:mx-auto 2xl:pl-20">
                    ...
                    {ladder.records.map((record) => <li className="player flex w-full mx-auto bg-29  py-1 px-2 justify-between gap-2 md:rounded-lg md:w-11/12 2xl:w-1/2 2xl:mx-0" key={record.player.id}>
                        ...
                        <div onClick={() => deletePlayerFromLadder(record, ladder)} className="trash-slide h-full flex justify-center items-center align-cente cursor-pointer">
